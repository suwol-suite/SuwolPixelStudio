...
const labels = {
  en: {
    ...
    toolGuide: "Tools",
    colorGuide: "Colors and Palette",
    layerGuide: "Layers",
    animationGuide: "Animation",
  ...
  ko: {
    ...
    zoom100: "100%",
    zoomFit: "화면에 맞추기",
    onionSkin: "앞뒤 프레임 겹쳐 보기",
    onionSkinSettings: "앞뒤 프레임 겹쳐 보기 설정…",
...
export function installApplicationMenu(
  ...
  template.push(
    ...
    },
    {
      label: t.help,
      submenu: [
        { label: t.quickStart, click: commandClick(window, "help.quickStart") },
        { label: t.toolGuide, click: commandClick(window, "help.tools") },
        { label: t.colorGuide, click: commandClick(window, "help.colorsPalette") },
        { label: t.layerGuide, click: commandClick(window, "help.layers") },
        { label: t.animationGuide, click: commandClick(window, "help.animation") },
        { label: t.shortcutGuide, click: commandClick(window, "help.shortcuts") },
        { label: t.troubleshooting, click: commandClick(window, "help.troubleshooting") },
        { type: "separator" },
        { label: t.about, click: commandClick(window, "help.about") },
      ],
    },
  );
